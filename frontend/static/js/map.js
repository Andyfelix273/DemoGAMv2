...
// =============================================
const BIM_ASSET_IDS_MODAL = [1, 2, 6, 7];
...
async function apriModaleAsset(id) {
  ...
  try {
    ...
    // Tab Planimetria: visibile solo per asset con dati BIM
    ...
    try {
      ...
      document.getElementById('mm-panel-workorders').innerHTML = '<p style="color:var(--text-secondary);font-size:13px">Work order non disponibili</p>';
    }
    ...
    try {
      ...
      document.getElementById('mm-panel-documenti').innerHTML = '<p style="color:var(--text-secondary);font-size:13px">Documenti non disponibili</p>';
    }

  } catch(e) {
    document.getElementById('mm-panel-anagrafica').innerHTML = `<p style="color:#E74C3C">${e.message}</p>`;
  }
}
...
(function() {
  ...
  (function() {
    ...
    sb.innerHTML = `
      ...
      <a href="/static/asset-efficiency.html" class="sb-btn" title="Asset Efficiency">
